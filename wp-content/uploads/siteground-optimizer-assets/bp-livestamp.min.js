(function($,moment){var updateInterval=1e3,paused=!1,$livestamps=$([]),init=function(){livestampGlobal.resume()},prep=function($el,timestamp){var oldData=$el.data('livestampdata');if(typeof timestamp=='number')
...
$this.html(to);}}});$livestamps=$livestamps.not(toRemove)},pause:function(){paused=!0},resume:function(){paused=!1;run()},interval:function(interval){if(interval===undefined)
